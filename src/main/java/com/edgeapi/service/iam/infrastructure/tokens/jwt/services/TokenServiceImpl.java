package com.edgeapi.service.iam.infrastructure.tokens.jwt.services;
...
public class TokenServiceImpl implements BearerTokenService {
     ...
     *
     * @param deviceId the username for which the token is to be generated
     *                 el nombre de usuario para el cual se generará el token
     * @return a JWT token as a String
     *         un token JWT como una cadena
     */
    public String generateToken(String deviceId) {
        return buildTokenWithDefaultParameters(deviceId);
    }
     ...
     *
     * @param deviceId the username to be included in the token
     *                 el nombre de usuario que se incluirá en el token
     * @return a JWT token as a String
     *         un token JWT como una cadena
     */
    private String buildTokenWithDefaultParameters(String deviceId) {
