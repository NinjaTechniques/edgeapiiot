package com.auth.service.iam.infrastructure.authorization.sfs.services;

import com.auth.service.iam.infrastructure.authorization.sfs.model.UserDetailsImpl;
